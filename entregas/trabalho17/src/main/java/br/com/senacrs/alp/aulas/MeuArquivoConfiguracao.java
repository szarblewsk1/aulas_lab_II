...
public class MeuArquivoConfiguracao implements ArquivoConfiguracao {
	...
	MeuArquivoConfiguracao(String arquivoEntrada) {
		...
		LeitorArquivos leitorArqivo = new MeuLeitorArquivos();
		String[] chaves = null;
		...
		InterpretadorStrings validador = new MeuInterpretadorStrings();
