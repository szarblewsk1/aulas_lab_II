...
public class MeuObterCabecalho implements ObterCabecalhoRequisicaoGet {
	...
	public MeuObterCabecalho(ArquivoConfiguracao config) {
		this.config = config;
	...
	public String[] obterCabecalhoResposta(Reader requisicao) {
		...
		String arqDir = null;
		File file = null;
		File error404 = new File(config.getErrorDir() + File.separator
				+ ERROR_404_HTML);
	...
	private String[] obterResposta(String http, File file) {
		...
		resultado[1] = "Date: " + obterDataFormatada()
				+ ObterCabecalhoRequisicaoGet.NOVA_LINHA;
		resultado[2] = "Server: " + ObterCabecalhoRequisicaoGet.SERVER
				+ ObterCabecalhoRequisicaoGet.NOVA_LINHA;
		resultado[3] = "Content-Length: " + file.length()
				+ ObterCabecalhoRequisicaoGet.NOVA_LINHA;
		resultado[4] = "Content-Type: text/html; charset=utf-8"
				+ ObterCabecalhoRequisicaoGet.NOVA_LINHA;
		resultado[5] = "Connection: close"
				+ ObterCabecalhoRequisicaoGet.NOVA_LINHA;
